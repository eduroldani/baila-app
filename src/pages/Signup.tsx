    ...
    <div style={pageStyle}>
      <div style={boxStyle}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          <div>
            <label htmlFor="fullName" style={{ display: 'block', marginBottom: 4, fontSize: 13 }}>Full Name</label>
            <input id="fullName" type="text" value={fullName} onChange={e => setFullName(e.target.value)} required style={inputStyle} />
          </div>
          <div>
          ...
          {message && <p style={{ color: '#aaa', margin: 0, fontSize: 13 }}>{message}</p>}
